...
var masks = [{src:'/img/frames/iko/short/masks/maskPinlines.png', name:'Pinline'}, {src:'/img/frames/iko/short/masks/maskTitle.png', name:'Title'}, {src:'/img/frames/iko/short/masks/maskType.png', name:'Type'}, {src:'/img/frames/iko/short/masks/maskRules.png', name:'Rules'}, {src:'/img/frames/iko/short/masks/maskNoBorder.png', name:'No Border'}, {src:'/img/frames/iko/short/masks/maskStraightBorder.png', name:'Straight Border'}, {src:'/img/frames/iko/short/masks/maskBorder.png', name:'Border'}];
