...
var masks = [{src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskPinlines.png', name:'Pinlines'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskTitle.png', name:'Title'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskLowerFrame.png', name:'Lower Frame'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskFrame.png', name:'Frame'}, {src:'/img/frames/custom/stoneCutter/masks/maskRules.png', name:'Rules Text'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskLegendary.png', name:'Legendary'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskFloating.png', name:'Floating Frame'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/extended/masks/maskBorder.png', name:'Border'}];
