...
availableFrames = [
	{name:'White Frame', src:'/img/frames/saga/creature/ub/transform-back/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/saga/creature/ub/transform-back/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/saga/creature/ub/transform-back/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/saga/creature/ub/transform-back/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/saga/creature/ub/transform-back/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/saga/creature/ub/transform-back/m.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'sagaCreatureUBTransformBack';
