...
document.querySelector('#loadFrameVersion').onclick = async function() {
    ...
    setTimeout(() => {
        ...
        // Apply borderless frame-specific settings (override regular if switching)
        if (card.station && card.station.squares) {
            card.station.borderlessXOffset = 1; // Set borderless offset
            card.station.squares[1].width = 1712; // Set borderless width
            card.station.squares[1].x = 1; // Set borderless X position
            card.station.squares[2].width = 1712; // Set borderless width
            card.station.squares[2].x = 1; // Set borderless X position
        }
