...
availableFrames = [
    ...
    {name:'Holo Stamp', src:'/img/frames/fca/stamp.png', bounds:bounds},
    {name:'Grey Stamp', src:'/img/frames/fca/grey.png', bounds:bounds},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	card.version = 'fca';
	//art bounds
	card.artBounds = {x:0, y:0, width:1.005, height:0.9224};
	autoFitArt();
	//set symbol bounds
	...
	loadTextOptions({
		...
		rules: {name:'Rules Text', text:'', x:173/2010, y:1749/2814, width:1679/2010, height:775/2814, size:0.035, outlineWidth:0.008, font:'Plantin MT Pro', color:'white'},
