...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		rules: {name:'Rules Text', text:'', x:173/2010, y:1770/2814, width:1679/2010, height:775/2814, size:0.036, lineSpacing: -0.1, outlineWidth:0.008, font:'Plantin MT Pro', color:'white', noVerticalCenter:true},
