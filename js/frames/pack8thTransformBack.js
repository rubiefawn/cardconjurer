...
var masks = [{src:'/img/frames/8th/dfc/back/pinline.png', name:'Pinline'}, {src:'/img/frames/8th/dfc/front/title.png', name:'Title'}, {src:'/img/frames/8th/type.png', name:'Type'}, {src:'/img/frames/8th/rules.png', name:'Rules'}, {src:'/img/frames/8th/dfc/back/frame.png', name:'Frame'}, {src:'/img/frames/8th/border.png', name:'Border'}];
...
availableFrames = [
	...
	{name:'Blue Frame', src:'/img/frames/8th/dfc/back/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/8th/dfc/back/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/8th/dfc/back/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/8th/dfc/back/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/8th/dfc/back/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/8th/dfc/back/a.png', masks:masks},

	{name:'White Power/Toughness', src:'/img/frames/8th/dfc/back/pt/w.png', bounds:bounds},
	{name:'Blue Power/Toughness', src:'/img/frames/8th/dfc/back/pt/u.png', bounds:bounds},
	{name:'Black Power/Toughness', src:'/img/frames/8th/dfc/back/pt/b.png', bounds:bounds},
	{name:'Red Power/Toughness', src:'/img/frames/8th/dfc/back/pt/r.png', bounds:bounds},
	{name:'Green Power/Toughness', src:'/img/frames/8th/dfc/back/pt/g.png', bounds:bounds},
	{name:'Multicolored Power/Toughness', src:'/img/frames/8th/dfc/back/pt/m.png', bounds:bounds},
	{name:'Artifact Power/Toughness', src:'/img/frames/8th/dfc/back/pt/a.png', bounds:bounds},
	{name:'Colorless Power/Toughness', src:'/img/frames/8th/dfc/back/pt/l.png', bounds:bounds},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	notify('If you intend to add the color identity pips, we recommend that you shift your Type text to the right with "{right83}".')
	//bottom info
	loadBottomInfo({
