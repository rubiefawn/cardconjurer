...
availableFrames = [
	...
	{name:'Blue Frame', src:'/img/frames/8th/dfc/front/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/8th/dfc/front/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/8th/dfc/front/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/8th/dfc/front/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/8th/dfc/front/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/8th/dfc/front/a.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = '8thTransformFront';
	...
	loadTextOptions({
		...
		title: {name:'Title', text:'', x:338/2010, y:0.0629, width:1499/2010, height:0.0429, oneLine:true, font:'matrixb', size:0.0429},
		...
		reminder: {name:'Reverse PT', text:'', x:136/2010, y:2391/2814, width:1684/2010, height:102/2814, size:0.035, oneLine:true, color:'#555', align:'right', font:'matrixbsc'},
