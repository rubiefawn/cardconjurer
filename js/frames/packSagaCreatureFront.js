...
availableFrames = [
	{name:'White Frame', src:'/img/frames/saga/creature/transform-front/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/saga/creature/transform-front/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/saga/creature/transform-front/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/saga/creature/transform-front/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/saga/creature/transform-front/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/saga/creature/transform-front/m.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'sagaCreatureTransformFront';
