...
var masks = [{src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskPinlines.png', name:'Pinlines'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskFrame.png', name:'Frame'}, {src:'/img/frames/custom/stoneCutter/masks/maskRules.png', name:'Rules Text'}, {src:'/img/frames/custom/stoneCutter/masks/maskDual.png', name:'Dual Land'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorderless.png', name:'Borderless'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorder.png', name:'Border'}];
