...
var masks = [{src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskPinlines.png', name:'Pinlines'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskFrame.png', name:'Frame'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskRules.png', name:'Rules Text'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskDual.png', name:'Dual Land'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorderless.png', name:'Borderless'}, {src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/masks/maskBorder.png', name:'Border'}];
...
availableFrames = [
	{name:'White Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/m.png', masks:masks},
	{name:'Colorless Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/c.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/custom/stoneCutter/stoneCutterDeluxe/L.png', masks:masks},
